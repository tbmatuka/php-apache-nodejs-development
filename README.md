# Local PHP and Node.js development docker setup
...
Mac OS has pretty slow file sharing with Docker and in most cases we suggest installing nvm and yarn on the host and running the watcher on the host. If you want to use our wildacrd SSL certificate, you can either copy it from one of the docker images or from our Git repository. The key and certificates are located in `/etc/ssl/docker/`.
...
Hostname: `localhost`, `127.0.0.1` or any subdomain of `loc-dev.com`
